// Single location to store and pull SVGs from
...
/**
 * Copy a SM logo SVG file content
 * Open SVGR Playground in browser ( react-svgr.com/playground/ )
 *    This tool is used to convert SVGs into React Components
 * Paste SVG into `SVG INPUT`
 * Copy component (exclude imports and exports)
 * In this file, paste copied component.
 *    Export component
 *    Rename component to what it is
 *      SVG: 'linkedin.svg'
 *      Component: LinkedInIcon
 *    Replace `props` argument with `{className, ...rest}`
 *    Where {...props}, replace with {...rest}
 * In <svg>
 *    Replace {...props} with {...rest}
 *    Remove `fill="none"`
 *    Add `className={cx(className, "w-full h-auto")}`
 *    Add `viewBox="0 0 42 43"` 
 *        viewBox is important when resizing an SVG element
 *        42 == SVG width
 *        43 = SVG height
 */