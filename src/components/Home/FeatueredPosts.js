...
import BlogLayoutOne from '../BlogLayouts/BlogLayoutOne'
import BlogLayoutTwo from '../BlogLayouts/BlogLayoutTwo'

const FeatueredPosts = ({blogs}) => {
